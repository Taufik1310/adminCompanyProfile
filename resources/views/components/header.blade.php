<div class="iq-navbar-header" style="height: 215px">
                ...
                >
                    <div>
                        ...
                        <p>
                            ...
                            admins like you manage successful
    ...
    <div class="iq-header-img">
        ...
        />
        <img
            src="{{ asset('assets/images/dashboard/top-header1.png') }}"
            alt="header"
        ...
        />
        <img
            src="{{ asset('assets/images/dashboard/top-header3.png') }}"
            alt="header"
            class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX"
        />
        <img
            src="{{ asset('assets/images/dashboard/top-header4.png') }}"
            alt="header"
