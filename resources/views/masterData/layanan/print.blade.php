        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-2" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <a href="{{ url('layanan') }}" class="btn bg-white border border-primary border-2 text-primary">Kembali</a>
                </div>
                <div
                    class="card"
                    data-aos="fade-up"
                            ...
                            <table id="datatable" class="table table-striped text-primary" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col col-1">ID Layanan</th>
                                            <th scope="col col-2">Nama Layanan</th>
