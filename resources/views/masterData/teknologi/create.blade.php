                ...
                >
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title text-primary">Tambah Data Teknologi Inti</h4>
                        </div>
                    </div>
                    <div class="card-body text-primary">
                        <form class="form-horizontal" action="{{ url('teknologi') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center mb-0" for="id_teknologi">ID Teknologi</label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control border-primary" id="id_teknologi" name="id_teknologi">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center mb-0" for="nama_teknologi">Nama Teknologi</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control border-primary" id="nama_teknologi" name="nama_teknologi">
                                </div>
                            </div>
                            <div class="form-group row">
