                ...
                >
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title text-primary">Tambah Data Jabatan</h4>
                        </div>
                    </div>
                    <div class="card-body text-primary">
                        <form class="form-horizontal" action="{{ url('jabatan') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control border-primary text-dar" id="id_jabatan" name="id_jabatan">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center mb-0" for="nama_jabatan">Nama Jabatan</label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control border-primary" id="nama_jabatan" name="nama_jabatan">
                                </div>
                            </div>
