                ...
                >
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title text-primary">Tambah Data Prinsip</h4>
                        </div>
                    </div>
                    <div class="card-body text-primary">
                        <form class="form-horizontal" action="{{ url('prinsip') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center mb-0" for="id_prinsip">ID Prinsip</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control border-primary text-dar" id="id_prinsip" name="id_prinsip">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center mb-0" for="nama_prinsip">Nama Prinsip</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control border-primary" id="nama_prinsip" name="nama_prinsip">
                                </div>
                            </div>
                            <div class="form-group row">
