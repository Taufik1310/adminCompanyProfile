            ...
            <div class="col-12">
                ...
                >
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ url('departemen/print') }}" class="btn bg-transparent border border-primary text-primary"><i class="bi bi-printer-fill"></i> Cetak</a>
                            <a href="{{ url('departemen/create') }}" class="btn btn-primary">Tambah</a>
                        </div>
                    </div>
                    <div class="card-body">
                                                ...
                                                <td>
                                                    <div class="dropstart">
                                                        ...
                                                        <ul class="dropdown-menu bg-primary">
                                                            <li>
                                                                <a class="dropdown-item text-center text-white" href="{{ url('departemen/'.$item->id_departemen.'/edit') }}">Edit</a>
                                                            </li>
                                                            <li><hr class="dropdown-divider"></li>
                                                            <li>
                                                              <form action="{{ url('departemen/'.$item->id_departemen) }}" enctype="multipart/form-data" method="POST">
                                                                @csrf
                                                                @method('DELETE')
