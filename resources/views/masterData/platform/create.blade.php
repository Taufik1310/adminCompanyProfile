                ...
                >
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title text-primary">Tambah Data Platform</h4>
                        </div>
                    </div>
                    <div class="card-body text-primary">
                        <form class="form-horizontal" action="{{ url('platform') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center mb-0" for="id_platform">ID Platform</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control border-primary" id="id_platform" name="id_platform">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center mb-0" for="nama_platform">Nama Platform</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control border-primary" id="nama_platform" name="nama_platform">
                                </div>
                            </div>
                            <div class="form-group row">
