            ...
            <div class="col-12">
                ...
                >
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ url('komisaris/print') }}" class="btn bg-transparent border border-primary text-primary"><i class="bi bi-printer-fill"></i> Cetak</a>
                            <a href="{{ url('komisaris/create') }}" class="btn btn-primary">Tambah</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="datatable" class="table table-striped text-primary" data-toggle="data-table">
                                    ...
                                    <tbody>
                                        @foreach ($komisaris as $item)
                                            <tr>
                                                <th class="text-primary text-wrap" scope="row">{{ $item->id_komisaris }}</th>
                                                ...
                                                <td>
                                                    <div class="dropstart">
                                                        ...
                                                        <ul class="dropdown-menu bg-primary">
                                                            <li>
                                                                <a class="dropdown-item text-center text-white" href="{{ url('komisaris/'.$item->id_komisaris) }}">Detail</a>
                                                            </li>
                                                            <li><hr class="dropdown-divider"></li>
                                                            <li>
                                                                <a class="dropdown-item text-center text-white" href="{{ url('komisaris/'.$item->id_komisaris.'/edit') }}">Edit</a>
                                                            </li>
                                                            <li><hr class="dropdown-divider"></li>
                                                            <li>
                                                              <form action="{{ url('komisaris/'.$item->id_komisaris) }}" enctype="multipart/form-data" method="POST">
                                                                @csrf
                                                                @method('DELETE')
