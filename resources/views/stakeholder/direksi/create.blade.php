                ...
                >
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title text-primary">Tambah Data Direksi</h4>
                        </div>
                    </div>
                    <div class="card-body text-primary">
                        <form class="form-horizontal" action="{{ url('direksi') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center mb-0" for="id_direksi">ID Direksi</label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control border-primary" id="id_direksi" name="id_direksi">
                                </div>
                            </div>
                            <div class="form-group row">
